...
export function MicroGlobe({ className, alt = 'Micro Globe' }: { className?: string; alt?: string }): ReactElement {
    return (
        <svg
            className={classNames(className, 'fill-current', 'Svg', 'Svg__microGlobe')}
            width="100%"
            viewBox="0 0 16 16"
