import React, { Fragment, MouseEventHandler, ReactElement, useCallback } from 'react';
...
export function ContentList(_props: ContentListProps): ReactElement {
    ...
    return (
        <ContentListUI
            ...
            onBackFromContent={useCallback((event) => onSelectContent(event, { value: null }), [onSelectContent])}
